...
class AppTheme {
  ...
  static ThemeData _build(AppColorsExtension c, Brightness brightness) {
    ...
    return ThemeData(
      ...
      extensions: [c],
      // Lime-tinted ripple everywhere a Material InkWell fires.
      // splashFactory uses InkRipple (radial pulse from tap point).
      // Higher contrast in dark, softer in light.
      splashColor: c.lime.withValues(alpha: isDark ? 0.14 : 0.10),
      highlightColor: c.lime.withValues(alpha: isDark ? 0.06 : 0.04),
